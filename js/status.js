...
// RESPEC (JOB OPS): Compact summary card linking to JOB OPS.
// Detailed career action has moved to OPS → JOB OPS segment.
// Career skills section stays in STATUS — it is a growth tracker.
// ═══════════════════════════════════════════════════════════════
        ...
        return `
            <div class="status-section status-section--path">
                ...
                <div class="path-tab-empty">
                    ...
                    <p class="path-tab-empty-sub">Complete onboarding to see your career track and job operations.</p>
                </div>
            </div>
        `;
    }
